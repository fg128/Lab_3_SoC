...
// ## As you add more slaves, you need to extend this logic to select them
        case(HADDR[31:24])      // Use the top 8 bits of the address to select
            // ROM at 0x0000_0000 to 0x00FF_FFFF
            ...
            // RAM at 0x2000_0000 to 0x20FF_FFFF
            ...
            // GPIO at 0x5000_0000 to 0x50FF_FFFF
            ...
            // UART at 0x5100_0000 to 0x51FF_FFFF
            ...
            // SPI at 0x5200_0000 to 0x52FF_FFFF
